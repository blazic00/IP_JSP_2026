...
<div class="container">
    ...
    <a href="applications.jsp"
       ...
       style="display: inline-block; width: auto; min-width: unset; padding: 0 16px;">
        ←
    </a>
</div>
    <!-- PAGE TITLE -->
    ...
    <div class="card hoverable">
        ...
        <div class="card-content">
            ...
            <div class="worklog-container">
                ...
                <%
                    if (studentInternship.getWorkLogList() != null &&
...
function onSaveEvaluation(event, form) {
    ...
    const studentInternshipId =
        formData.get("studentInternshipId");

    const url =
        "http://localhost:8080/api/student-internship/" +
        studentInternshipId;
